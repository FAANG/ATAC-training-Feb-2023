...
This is a dimer: should we mention this or choose a different TF?

NB can we link to the nicer Ensembl version here just to show off?

are these really PWMs?

```{r, warnings=FALSE, message=FALSE}
library(jsonlite)
library(TFBSTools)

pfms = fromJSON("ensembl_pwms_mono_human.json", simplifyDataFrame = F)
